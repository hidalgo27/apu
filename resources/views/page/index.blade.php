...
@section('content')
    ...
    <div class="bg-fixed bg-center h-128" style="background-image: url({{asset('images/banner-textil.png')}}); -webkit-background-size: auto 42rem; -webkit-background-size: auto 42rem"></div>
